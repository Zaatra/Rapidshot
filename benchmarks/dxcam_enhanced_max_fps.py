...
parser = argparse.ArgumentParser(description='DXCam Enhanced Max FPS Benchmark')
...
title = "[DXCam Enhanced] Max FPS Benchmark"
...
cam = dxcam.create(output_color=args.color, nvidia_gpu=args.gpu)

# Warm-up (some systems need this for stable measurements)
_ = cam.grab(region=region)
time.sleep(0.1)
